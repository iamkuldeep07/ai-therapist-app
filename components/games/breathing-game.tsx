  ...
  if (isComplete) {
    return (
      <div className="flex flex-col items-center justify-center h-[400px] space-y-6">
        ...
        <p className="text-[hsl(215,16%,45%)] text-center max-w-sm">
        ...
        >
          <div className="relative w-32 h-32 mx-auto">
            <motion.div
              ...
              className="absolute inset-0 bg-[hsl(150,30%,60%)]/10 rounded-full"
            />
            <div className="absolute inset-0 flex items-center justify-center">
              <Wind className="w-8 h-8 text-[hsl(150,30%,60%)]" />
            </div>
          </div>
