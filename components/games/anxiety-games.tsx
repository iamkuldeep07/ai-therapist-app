      ...
      <Card className="border-[hsl(150,30%,60%)]/10">
        <CardHeader>
          <CardTitle className="text-xl font-semibold flex items-center gap-2">
            <Gamepad2 className="h-5 w-5 text-[hsl(150,30%,60%)]" />
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {games.map((game) => (
              ...
              >
                <Card
                  className={`border-[hsl(150,30%,60%)]/10 hover:bg-[hsl(150,30%,60%)]/5 transition-colors cursor-pointer $ 
                        {
                           selectedGame === game.id ? "ring-2 ring-[hsl(150,30%,60%)]" : ""
                        }`}
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-[hsl(215,16%,45%)] mt-1">
                          {game.description}
                        </p>
                        <div className="flex items-center gap-2 mt-3">
                          <Music2 className="h-4 w-4 text-[hsl(215,16%,45%)]" />
                          <span className="text-sm text-[hsl(215,16%,45%)]">
                            {game.duration}
                          </span>
                        </div>
                      </div>
